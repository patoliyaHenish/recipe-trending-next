        ...
        <Box>
          ...
          <Box sx={{ width: '100%' }}>
            <Box sx={{
              ...
              {/* Right Column: Desktop/Laptop Stacked Adsterra Ads */}
              <Box
                sx={{
              ...
              {/* Main Content Area: Prep info, Ingredients, Steps */}
                ...
                >
                    ...
                    <Box sx={{ px: { xs: 0.5, sm: 3, md: 8, lg: 12 }, py: 2.2 }}>
                      <Box className={`grid ${recipe.rest_time > 0 ? 'grid-cols-2 sm:grid-cols-3' : 'grid-cols-2'} gap-x-2 gap-y-3 sm:gap-3`}>
                        <Box className="flex items-center space-x-1 sm:space-x-2">
                          ...
                          <span
                            className={`text-[0.82rem] sm:text-base font-medium ml-0.5 sm:ml-1 ${isDarkMode ? "text-white" : "text-black"
                              }`}
                          >
                  ...
                  {recipe?.note && recipe.note.trim() !== "" && recipe.note.toLowerCase() !== "null" && (
                    ...
                    >
                      ...
                      <div
                        className={`text-[0.95rem] whitespace-pre-line text-left leading-relaxed ${isDarkMode ? "text-slate-300" : "text-slate-600"
                          }`}
                      >
                        {recipe.note}
                      </div>
          ...
          <Box sx={{ mt: 3, mb: 1, width: "100%", display: "flex", justifyContent: "center" }}>
            <AdsterraFooterBanner />
          </Box>
