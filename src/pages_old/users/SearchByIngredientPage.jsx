...
import { Box, Typography, InputBase, Button, Chip, Stack, CircularProgress, IconButton, Paper, ClickAwayListener, Container } from '@mui/material';
...
const SearchByIngredientPage = () => {
  ...
  useEffect(() => {
    document.title = "Search by Ingredient | Recipe Trending";
  ...
  return (
    <Box className={`min-h-[80vh] pt-24 pb-12 md:pt-32 md:pb-24 ${isDarkMode ? 'bg-[#121212]' : 'bg-[#fdf8f3]'}`}>
