...
import { useVerifyEmailMutation, useMyProfileQuery, useUpdatePreferenceMutation } from '../features/api/authApi';
import { Box, Typography, Button, CircularProgress } from '@mui/material';
import { CheckCircle, ErrorOutlined as ErrorOutline, MarkEmailRead, HomeRounded } from '@mui/icons-material';
...
const VerifyEmail = () => {
    ...
    useEffect(() => {
        ...
        if (email && token && !effectRan.current) {
    ...
    const renderContent = () => {
        switch (verificationStatus) {
            case 'verifying':
                return (
                    <>
                        <motion.div initial="hidden" animate="visible" variants={itemVariants} className="mb-6 relative">
                        ...
                        <motion.div variants={itemVariants}>
                            <Typography variant="h4" sx={{ fontWeight: 800, mb: 2, background: 'linear-gradient(45deg, #F97C1B, #FFB15E)', backgroundClip: 'text', textFillColor: 'transparent', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                                Verifying...
                            </Typography>
                            <Typography variant="body1" sx={{ color: isDarkMode ? '#aaa' : '#666', maxWidth: '300px', mx: 'auto' }}>
                ...
                return (
                    <>
                        ...
                        <motion.div variants={itemVariants}>
                            ...
                            <Typography variant="body1" sx={{ color: isDarkMode ? '#aaa' : '#666', mb: 3, maxWidth: '350px', mx: 'auto', lineHeight: 1.6 }}>
                                Your account has been successfully verified.
                            </Typography>
                            <Typography variant="h6" sx={{ color: isDarkMode ? '#F97C1B' : '#F97C1B', fontWeight: 700, mb: 1, fontFamily: "'Basic', sans-serif", letterSpacing: 1 }}>
                ...
                return (
                    <>
                        ...
                        <motion.div variants={itemVariants}>
                            ...
                            <Typography variant="body1" sx={{ color: isDarkMode ? '#aaa' : '#666', mb: 4, maxWidth: '350px', mx: 'auto' }}>
